...
class MainWindow:
    ...
    def _build_layout(self) -> None:
        ...
        header = ttk.LabelFrame(self.root, text="Selected World", padding=16)
        ...
        editors = ttk.Frame(self.root, padding=(0, 16, 16, 0))
        ...
        status_bar = ttk.Frame(self.root, padding=(16, 8))
    ...
    def _run_background(self, task, on_success, *, start_message: str) -> None:
        ...
        def poll() -> None:
            ...
            try:
                ...
                messagebox.showerror("Minecraft Server Manager", str(exc), parent=self.root)
                return
            on_success(result)
